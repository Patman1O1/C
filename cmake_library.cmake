...
set(LIBRARY_TYPE "" CACHE STRING "LIBRARY_TYPE \"\^(STATIC|SHARED)\$\"") # Required
...
if (NOT LIBRARY_TYPE MATCHES "^(STATIC|SHARED)$")
    message(FATAL_ERROR "-DLIBRARY_TYPE was not specified as STATIC or SHARED")
endif()
...
configure_file(
        ...
        "${LIBRARY_SOURCE_DIR}/include/${LIBRARY_NAME}/${LIBRARY_NAME}.h"
        @ONLY
)
...
configure_file(
        "${TEMPLATE_DIR}/main/main.c.in"
        "${LIBRARY_SOURCE_DIR}/main/main.c"
        @ONLY
)
